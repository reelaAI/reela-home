...
const Footer = () => {
  return (
    <footer class='bg-white pt-16 pb-8 text-gray-900 border-t border-gray-200'>
      <div class='max-w-[1200px] mx-auto px-4'>
        <div class='flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-8'>
          ...
          <div class='flex flex-wrap gap-4'>
            <a
              class='inline-flex h-12 w-12 items-center justify-center rounded-full border border-gray-200 text-gray-900 transition-colors duration-300 hover:bg-black hover:text-white'
              aria-label='Twitter'
              target='_blank'
          ...
          <div>
            ...
            <ul class='mt-4 space-y-2 text-gray-600'>
              {products.map(item => (
                <li
                  key={item.href}
                  class='hover:underline hover:text-gray-900 transition-colors duration-200 max-w-max'
                >
