...
const Footer = () => {
  return (
    <footer class='border-t border-gray-100 bg-white pt-16 pb-8 text-gray-900'>
      <div class='mx-auto max-w-[1200px] px-4'>
        <div class='mb-12 flex flex-col items-start justify-between md:flex-row md:items-center'>
          ...
          <div class='flex flex-wrap gap-4'>
            <a
              class='rounded-full border border-gray-200 bg-white p-3 text-gray-900 transition-colors duration-300 hover:border-[#ff0058] hover:bg-[#ff0058]/90 hover:text-white'
              aria-label='Twitter'
              target='_blank'
        ...
        <div class='py-8'>
          ...
          <div class='flex flex-wrap gap-2'>
            <a
              class='text-xs rounded-full border border-gray-200 px-3 py-1 text-gray-600 transition-colors duration-200 hover:border-[#ff0058] hover:bg-[#ff0058]/90 hover:text-white'
              href='#'
            >
              AI Video Creation
            </a>
