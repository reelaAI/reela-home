    ...
    <>
      ...
      <form action='/subscribe' method='post'>
        <div class='relative mx-auto mb-20 flex max-w-[1200px] flex-wrap justify-center gap-4 px-4'>
          <label class='peer/y has-checked:bg-brand has-checked:text-white mb-4 rounded-full border border-white/10 bg-white/10 px-6 py-2 text-slate-200 transition-colors hover:border-brand/40'>
          ...
          <label class='peer/m has-checked:bg-brand has-checked:text-white mb-4 rounded-full border border-white/10 bg-white/10 px-6 py-2 text-slate-200 transition-colors hover:border-brand/40'>
      ...
      <div class='mx-auto mb-20 max-w-[1200px] px-4'>
        <div
          class='relative overflow-hidden rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_top_right,_rgba(255,0,88,0.35),_rgba(12,10,25,0.9)_60%)] p-12 text-white shadow-[0_30px_120px_rgba(0,0,0,0.55)] md:p-16'
        >
          <div class='max-w-4xl'>
            <h2 class='mb-6 text-[3rem] font-bold'>
              Enterprise-Ready AI Video Solutions
            </h2>
            <p class='mb-4 text-base text-slate-200 md:text-lg'>
            ...
            <a href='mailto:contact@reela.ai'>
              <button class='inline-flex items-center rounded-full bg-brand/10 px-6 py-3 text-lg font-medium text-white transition-transform hover:scale-105 hover:bg-brand/20'>
                Contact Sales
                <Icon
                  name='external'
