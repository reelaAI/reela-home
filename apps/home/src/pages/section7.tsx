    ...
    <>
      ...
      <form action='/subscribe' method='post'>
        <div class='relative mx-auto mb-20 flex max-w-[1200px] flex-wrap justify-center px-4'>
          <label class='peer/y has-checked:bg-brand has-checked:text-white has-checked:shadow-[0_10px_30px_rgba(255,0,88,0.25)] mb-4 rounded-full border border-gray-200 bg-white px-6 py-2 text-gray-800 transition-all duration-200'>
          ...
          <label class='peer/m has-checked:bg-brand has-checked:text-white has-checked:shadow-[0_10px_30px_rgba(255,0,88,0.25)] mb-4 ml-4 rounded-full border border-gray-200 bg-white px-6 py-2 text-gray-800 transition-all duration-200'>
      ...
      <div class='mx-auto mb-20 max-w-[1200px] px-4'>
        <div
          class='relative overflow-hidden rounded-3xl p-12 text-white shadow-[0_32px_70px_rgba(0,0,0,0.18)] md:p-16'
          style='background: linear-gradient(135deg, rgba(255, 0, 88, 0.88) 0%, rgba(20, 20, 20, 0.9) 100%)'
        >
          <div class='max-w-4xl'>
