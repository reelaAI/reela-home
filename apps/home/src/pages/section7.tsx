    ...
    <>
      ...
      <form action='/subscribe' method='post'>
        <div class='relative mx-auto mb-20 flex max-w-[1200px] flex-wrap justify-center px-4 text-white'>
          <label class='peer/y has-checked:bg-brand has-checked:text-white mb-4 rounded-full border border-white/10 bg-white/10 px-6 py-2 text-slate-200 transition hover:bg-white/20'>
          ...
          <label class='peer/m has-checked:bg-brand has-checked:text-white mb-4 ml-4 rounded-full border border-white/10 bg-white/10 px-6 py-2 text-slate-200 transition hover:bg-white/20'>
      ...
      <div class='mx-auto mb-20 max-w-[1200px] px-4 text-white'>
        <div
          class='relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-brand via-[#ff3a78] to-[#8c0e35] p-12 shadow-[0_40px_120px_rgba(255,0,88,0.25)] md:p-16'
        >
          <div class='max-w-4xl'>
            <h2 class='mb-6 text-[3rem] font-bold'>
              Enterprise-Ready AI Video Solutions
            </h2>
            <p class='mb-4 text-base text-white/90 md:text-lg'>
            ...
            <a href='mailto:contact@reela.ai'>
              <button class='inline-flex items-center rounded-full bg-white px-6 py-3 text-lg font-medium text-brand shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-transform hover:scale-105'>
                Contact Sales
                <Icon
                  name='external'
