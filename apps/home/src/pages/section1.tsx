      ...
      <div class='mx-auto flex max-w-6xl flex-col items-center text-center'>
        ...
        <div class='mt-12 grid w-full max-w-5xl gap-4 text-left md:grid-cols-3'>
          {heroHighlights.map((highlight) => (
            <div
              key={highlight.title}
              class='flex h-full items-center gap-4 rounded-3xl border border-black/5 bg-white p-4 shadow-sm transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg md:p-5'
            >
              <div
        ...
        <div class='mt-10 flex flex-col items-center gap-6'>
          <a
            class='inline-flex items-center justify-center rounded-full bg-brand px-8 py-4 text-base font-semibold text-white shadow-sm transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2'
                ...
                {[brands, brands, brands].flat().map((brand, index) => (
                  ...
                  >
                    <img
                      ...
                      loading='lazy'
                      src={brand.src}
                      style='color: transparent; filter: grayscale(100%) brightness(85%);'
                      width='80'
                    />
