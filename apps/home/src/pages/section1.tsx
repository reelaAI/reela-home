  ...
  return (
    <section class='fade-in-up container mx-auto px-4 py-20 text-center'>
      <div class='mx-auto flex max-w-6xl flex-col items-center text-center'>
        <h1 class='font-inter font-bold leading-tight tracking-tight text-[4.5rem] text-neutral-950'>
          Video Creation,{' '}
          <span class='bg-gradient-to-r from-black via-neutral-800 to-black bg-clip-text text-transparent'>
            Automated.
          </span>
        </h1>
        <p class='font-inter mt-6 max-w-4xl text-base text-neutral-600 md:text-lg'>
        ...
        <div class='mt-12 grid w-full max-w-5xl gap-4 text-left md:grid-cols-3'>
          {heroHighlights.map((highlight) => (
            ...
            >
              ...
              <p class='text-base font-semibold text-neutral-900 md:text-lg'>{highlight.title}</p>
            </div>
          ))}
        </div>
        <div class='mt-10 flex flex-col items-center gap-6'>
          <a
            class='inline-flex items-center justify-center rounded-full bg-black px-8 py-4 text-base font-semibold text-white shadow-sm transition-all duration-200 hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2'
        ...
        <div class='mt-14 flex w-full items-center justify-center px-4'>
          <div class='flex flex-wrap items-center justify-center gap-6'>
            <p class='shrink-0 whitespace-nowrap font-medium text-neutral-900'>Powered by industry-leading AI models:</p>
            ...
            <div class='relative max-w-[90vw] overflow-x-hidden md:max-w-2xl'>
              <div class='animate-infinite-scroll mt-10 flex w-[1000%] md:mt-0'>
                {[brands, brands, brands].flat().map((brand, index) => (
                  <div
                    class='mx-8 flex flex-shrink-0 flex-col items-center justify-center gap-2 text-neutral-400'
                  ...
                  >
                    <img
                      ...
                      loading='lazy'
                      src={brand.src}
                      style='color: transparent; filter: grayscale(100%) brightness(0.75);'
                      width='80'
                    />
