...
const baseCardClasses =
  'testimonial-card group relative flex w-full max-w-[960px] flex-col gap-4 overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 text-white shadow-[0_24px_80px_rgba(5,6,14,0.65)] transition-[transform,box-shadow,opacity,margin] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] backdrop-blur lg:flex-row lg:items-start lg:gap-6 lg:p-5';

const positionClassMap: Record<CardPosition, string> = {
  active:
    'z-30 gap-6 p-6 shadow-[0_35px_120px_rgba(255,0,88,0.35)] ring-2 ring-brand/25 lg:-mx-16 lg:flex lg:items-center lg:gap-8 lg:p-8',
  prev:
...
const quoteBaseClasses = 'text-[11px] leading-relaxed text-gray-300';
...
const highlightBaseClasses = 'text-[10px] font-medium text-brand';
...
const Section6 = () => {
  ...
  return (
    <>
      <div class='container mx-auto mb-6 px-4 py-8 text-center text-white'>
        ...
        <p class='mx-auto mt-2 max-w-2xl text-base text-gray-300 md:text-lg'>
      ...
      <div class='mx-auto mb-20 max-w-[1200px] px-4 text-white'>
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <button
                      type='button'
                      class={`absolute right-3 top-3 rounded-full border border-white/20 bg-black/60 p-2 text-white transition hover:bg-black/80 ${
                  ...
                  >
                    <div class='flex flex-col items-start gap-4 lg:flex-row lg:items-center lg:justify-between'>
                      <span class='inline-block rounded-full border border-brand/30 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-brand lg:text-[11px]'>
                    ...
                    <div class='flex justify-start pt-1'>
                      <p class='inline-block rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-wide text-brand'>
                        {testimonial.role}
                      </p>
                    </div>
                  </div>
          ...
          <button
            type='button'
            class='absolute left-0 top-1/2 hidden -translate-y-1/2 rounded-full border border-white/20 bg-white/10 p-3 text-white shadow-[0_18px_40px_rgba(0,0,0,0.45)] transition hover:bg-white/20 sm:flex sm:z-30'
            data-carousel-prev=''
          ...
          <button
            type='button'
            class='absolute right-0 top-1/2 hidden -translate-y-1/2 rounded-full border border-white/20 bg-white/10 p-3 text-white shadow-[0_18px_40px_rgba(0,0,0,0.45)] transition hover:bg-white/20 sm:flex sm:z-30'
            data-carousel-next=''
