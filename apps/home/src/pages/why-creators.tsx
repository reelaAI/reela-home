        ...
        <div class='space-y-8'>
          {cards.map((card) => (
            ...
            >
              ...
              <div
                class='group relative aspect-[16/9] w-full self-center overflow-hidden rounded-2xl bg-white shadow-lg md:mx-auto md:max-w-[540px]'
                data-video-card
              >
                <div class='absolute inset-0' data-video-autoplay>
                  <video
                    ...
                    muted
                    data-video-element
                    onclick='pauseVideoOnClick(event, this)'
                  ...
                  <button
                    type='button'
                    class='pointer-events-none absolute right-4 top-4 flex h-11 w-11 items-center justify-center rounded-full bg-black/60 text-white opacity-0 shadow-lg transition-opacity transition-transform duration-200 hover:scale-105 focus-visible:pointer-events-auto focus-visible:opacity-100 group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100'
