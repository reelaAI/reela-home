...
const Section2 = () => {
  return (
    <section className='w-full border-y border-gray-100 bg-white px-4 py-12 md:py-16'>
      <div className='max-w-7xl mx-auto'>
        <h2 className='font-inter text-[3rem] font-bold text-center mb-4 text-black'>
...
function FeatureCard({
  ...
  return (
    <div
      className={cn(
        'rounded-2xl text-slate-950',
        'p-10 shadow-sm bg-white group relative overflow-hidden h-full border border-gray-100',
        'hover:-translate-y-3 hover:shadow-[0_24px_60px_-40px_rgba(255,0,88,0.6)] transition-all duration-500'
      )}
    >
      {/* Background decoration */}
      <div className='absolute top-0 right-0 w-40 h-40 opacity-10'>
        <div className='w-full h-full bg-brand rounded-full transform translate-x-20 -translate-y-20 blur-3xl'></div>
      </div>

      <div className='relative z-10'>
        <div className='flex flex-col items-center text-center space-y-8'>
          <div className='w-24 h-24 rounded-3xl border border-brand/30 bg-brand/10 flex items-center justify-center text-brand group-hover:scale-105 transition-all duration-500 shadow-sm'>
