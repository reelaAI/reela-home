...
import { Boxes, Layers, Sparkles, Timer } from 'lucide-react';
...
const iconMap = {
  timer: <Timer className='h-12 w-12' strokeWidth={1.75} />,
  sparkles: <Sparkles className='h-12 w-12' strokeWidth={1.75} />,
  boxes: <Boxes className='h-12 w-12' strokeWidth={1.75} />,
  layers: <Layers className='h-12 w-12' strokeWidth={1.75} />,
} as const;
