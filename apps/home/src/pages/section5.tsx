  ...
  return (
    <>
      <div class='container mx-auto mb-12 px-4 py-16 text-center'>
        <h2 class='font-inter text-[3rem] font-bold text-neutral-950'>Universal Video Capabilities</h2>
      </div>
        ...
        <div class='grid grid-cols-1 gap-6 md:grid-cols-3'>
          <div class='rounded-xl bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg'>
            <div class='flex flex-col items-start'>
              <div class='mb-4 rounded-lg bg-black/5 p-3'>
                <Icon
                  name='api'
                  className='lucide text-black h-8 w-8'
                />
              </div>
          ...
          <div class='rounded-xl bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg'>
            <div class='flex flex-col items-start'>
              ...
              <p class='text-neutral-600'>Support 16:9, 9:16, and 1:1 formats for any platform.</p>
            </div>
          </div>
          <div class='rounded-xl bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg'>
            <div class='flex flex-col items-start'>
