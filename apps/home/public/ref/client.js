...
function videoTabClick(element, tabName) {
  ...
  labels.forEach((label) => {
    label.classList.remove('bg-white', 'shadow-md', 'border-l-4', 'border-gray-900');
    label.classList.add('bg-white/50');
    label.querySelector('h3').classList.remove('text-gray-900');
  });

  element.classList.add('bg-white', 'shadow-md', 'border-l-4', 'border-gray-900');
  element.classList.remove('bg-white/50');
  element.querySelector('h3').classList.add('text-gray-900');
